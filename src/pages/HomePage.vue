<template>
  <div>
    {{ currentPageParts.landing_hero }}
    <LandingHero :blockContents="currentPageParts.landing_hero" ></LandingHero>
    <template v-for="pageContent in currentPage.ordered_visible_page_contents">
      <div>{{ pageContent.content.raw_en }}</div>
      <div><span v-html="pageContent.content.raw_en"></span></div>
    </template>
    <section>
